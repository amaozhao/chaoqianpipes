...
var _USER_EXPIRE = 1000 * 60*60*24*730; 
	...
	visittrack_log : function (_pk_site, _pk_pkurl) {
	    ...
	    setSessionCookie : function (name, value) {
	        ...
	        document.cookie = name + "=" + escape(value)+ ";domain="+getRootDomain()+";path=/;expires="+ expdate.toGMTString();
	    },
	    ...
	    setSessionFlag : function (name) {
	    	document.cookie = name + "=1;domain="+getRootDomain()+";path=/";
	    },
	    ...
	    delCookie : function (name) {
	        ...
	        document.cookie = name + "=" + cval + ";domain="+getRootDomain()+";path=/;expires=" + exp.toGMTString();
	    },
	...
	try {
		...
		if(116 == keycode){
			   _pk_rtu = document.location.href;
		}else{		
